...
insert into emp(emp_id,name, salary, email, department_id, department_name)

select employee_id, last_name, salary, email, department_id, department_name
from employees NATURAL join departments 
where department_id = 90;

commit;

update emp set name='Abduullah',  salary=100000, department_id=1001
where emp_id =102; 
